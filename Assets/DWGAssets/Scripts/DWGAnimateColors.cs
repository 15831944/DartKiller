...
{ 
	...
	/// which they change.
	/// </summary>
	public class DWGAnimateColors:MonoBehaviour
	{
		...
		// Should the animation start from a random color from the list?
		...
		public void Start()
		{
			if ( startRandom )   colorIndex = Mathf.FloorToInt(Random.Range( 0, colorList.Length)); 
